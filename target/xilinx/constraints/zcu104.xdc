...
set_property PACKAGE_PIN A20      [get_ports "uart_tx_o"] ;# Bank  28 VCCO - VCC1V8   - IO_L21P_T3L_N4_AD8P_28
set_property IOSTANDARD  LVCMOS18 [get_ports "uart_tx_o"] ;# Bank  28 VCCO - VCC1V8   - IO_L21P_T3L_N4_AD8P_28
set_property PACKAGE_PIN C19      [get_ports "uart_rx_i"] ;# Bank  28 VCCO - VCC1V8   - IO_L20N_T3L_N3_AD1N_28
set_property IOSTANDARD  LVCMOS18 [get_ports "uart_rx_i"] ;# Bank  28 VCCO - VCC1V8   - IO_L20N_T3L_N3_AD1N_28
...
set_property PACKAGE_PIN E23      [get_ports "sysclk_n"] ;# Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property IOSTANDARD  LVDS     [get_ports "sysclk_n"] ;# Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property PACKAGE_PIN F23      [get_ports "sysclk_p"] ;# Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28
set_property IOSTANDARD  LVDS     [get_ports "sysclk_p"] ;# Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28
...
set_property PACKAGE_PIN F5       [get_ports "test_mode_i"] ;# Bank  88 VCCO - VCC3V3   - IO_L9P_AD11P_88
set_property IOSTANDARD  LVCMOS33 [get_ports "test_mode_i"] ;# Bank  88 VCCO - VCC3V3   - IO_L9P_AD11P_88
set_property PACKAGE_PIN D4       [get_ports "boot_mode_i[1]"] ;# Bank  88 VCCO - VCC3V3   - IO_L8N_HDGC_88
set_property IOSTANDARD  LVCMOS33 [get_ports "boot_mode_i[1]"] ;# Bank  88 VCCO - VCC3V3   - IO_L8N_HDGC_88
set_property PACKAGE_PIN E4       [get_ports "boot_mode_i[0]"] ;# Bank  88 VCCO - VCC3V3   - IO_L8P_HDGC_88
set_property IOSTANDARD  LVCMOS33 [get_ports "boot_mode_i[0]"] ;# Bank  88 VCCO - VCC3V3   - IO_L8P_HDGC_88
...
set_property PACKAGE_PIN M11      [get_ports "cpu_resetn"] ;# Bank  87 VCCO - VCC3V3   - IO_L4N_AD8N_87
set_property IOSTANDARD  LVCMOS33 [get_ports "cpu_resetn"] ;# Bank  87 VCCO - VCC3V3   - IO_L4N_AD8N_87
...
set_property PACKAGE_PIN N12      [get_ports "i2c_scl_io"] ;# Bank  87 VCCO - VCC3V3   - IO_L1N_AD11N_87
set_property IOSTANDARD  LVCMOS33 [get_ports "i2c_scl_io"] ;# Bank  87 VCCO - VCC3V3   - IO_L1N_AD11N_87
set_property PACKAGE_PIN P12      [get_ports "i2c_sda_io"] ;# Bank  87 VCCO - VCC3V3   - IO_L1P_AD11P_87
set_property IOSTANDARD  LVCMOS33 [get_ports "i2c_sda_io"] ;# Bank  87 VCCO - VCC3V3   - IO_L1P_AD11P_87
...
set_property PACKAGE_PIN E33     [get_ports "sd_cd_i"] ;      # Bank 501 - PS_MIO45
#Other net   PACKAGE_PIN E34      - MIO46_SDIO_DAT0_R         Bank 501 - PS_MIO46
set_property PACKAGE_PIN E34     [get_ports "sd_d_io[0]"] ;   # Bank 501 - PS_MIO46
#Other net   PACKAGE_PIN F30      - MIO47_SDIO_DAT1_R         Bank 501 - PS_MIO47
set_property PACKAGE_PIN F30     [get_ports "sd_d_io[1]"] ;   # Bank 501 - PS_MIO47
#Other net   PACKAGE_PIN F31      - MIO48_SDIO_DAT2_R         Bank 501 - PS_MIO48
set_property PACKAGE_PIN F31     [get_ports "sd_d_io[2]"] ;   # Bank 501 - PS_MIO48
#Other net   PACKAGE_PIN F32      - MIO49_SDIO_DAT3_R         Bank 501 - PS_MIO49
set_property PACKAGE_PIN F32     [get_ports "sd_d_io[3]"] ;   # Bank 501 - PS_MIO49
#Other net   PACKAGE_PIN F33      - MIO50_SDIO_CMD_R          Bank 501 - PS_MIO50
set_property PACKAGE_PIN F33     [get_ports "sd_cmd_o"] ;     # Bank 501 - PS_MIO50
#Other net   PACKAGE_PIN F34      - MIO51_SDIO_CLK_R          Bank 501 - PS_MIO51
set_property PACKAGE_PIN F34     [get_ports "sd_sclk_o"] ;     # Bank 501 - PS_MIO51
